...
?>
    <div id="main">
        ...
        <p><?php echo __('MINDGRAPH installation has been completed successfully.');?></p>
        <h3 style="color:#FF7700;"><?php echo __('Stay up to date');?>: </h3>
        <?php echo __("It's important to keep your MINDGRAPH installation up to date. Get announcements, security updates and alerts delivered directly to you!");?>
        <!-- //aravind 44// -->
        <br><br>
    ...
    <div id="sidebar">
            ...
            <p>
               <?php echo __('Launching a new customer support platform can be a daunting task. Let us get you started! We provide professional support services to help get MINDGRAPH up and running smoothly for your organization.');?> <a target="_blank" href="https://osticket.com/services/professional-support/"><?php echo __('Learn More!');?></a>
            </p>
    </div>
