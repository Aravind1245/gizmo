...
?>
    <div id="main">
            ...
            <div id="intro">
             <p><?php echo __('MINDGRAPH installer requires ability to write to the configuration file, <b>include/ost-config.php</b>. A template copy is located in the include directory (<b>include/ost-sampleconfig.php</b>).');?>
             <!-- //aravind 46//-->
             </p>
            </div>
