...
implements RestrictedAccess, Threadable, Searchable {
    ...
    function getTicketType() {
        $alltickettypes = $this->getAlltickettypes();
        return $alltickettypes[$this->source] ?: $this->source;
    }
   ...
   /*============== Static functions. Use Ticket::function(params); =============nolint*/
    ...
    static function getAlltickettypes() {
        static $translated = false;
        if (!$translated) {
            foreach (static::$alltickettypes as $k=>$v)
                static::$alltickettypes[$k] = __($v);
        }

        return static::$alltickettypes;
    }
