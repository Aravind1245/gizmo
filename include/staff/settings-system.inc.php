...
$gmtime = Misc::gmtime();
?>
<h2><?php echo __('System Settings and Preferences');?> <small>— <span class="ltr">Mind Graph (<?php echo $cfg->getVersion(); ?>)</span></small></h2>
        ...
        <tr>
            ...
            <td>
                <select name="default_dept_id" data-quick-add="department">
                    ...
                    <option value="0" data-quick-add>&mdash; <?php echo __('IT Help Desk');?> &mdash;</option>
                ...
                <!-- changed by aravind change no 13 -->
            </td>
        </tr>
        <tr>
